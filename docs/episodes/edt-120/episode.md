...
Alan Evans is the principle technologist at Macrometa and focuses on bringing Global Data Networks to customers all 
over  the world. His insight into data management and the complexities of data management in global organizations is 
invaluable as Darren finds out in this interview. The focus of this interview is to understand the Laws of Edge 
computing and the characteristics of data that drive these new data architectures.
